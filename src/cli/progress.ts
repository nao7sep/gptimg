 ...
 * typed event (time, level, message, verb, stage, and any structured `data`),
 * one object per line. stdout stays reserved for the one-shot result document,
 * so progress never touches it. Not gated on whether stderr is a TTY: scripts
 * and agents watch stderr and want every line (§6).
 */
